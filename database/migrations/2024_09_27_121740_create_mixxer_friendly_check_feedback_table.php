...
return new class extends Migration
{
    ...
    {
        Schema::create('mixxer_friendly_check_feedback', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('issue_you_experiencing');
            $table->text('provide_more_details');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('mixxer_friendly_check_feedback');
    }
};
