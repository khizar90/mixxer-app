...
@section('main', 'Reported Users Management')
@section('link')
                            ...
                            <tbody>
                                @foreach ($list as $item)
                                    <tr class="odd">
                                        ...
                                        <td class="sorting_1">
                                            <div class="d-flex justify-content-start align-items-center user-name">
                                                @if ($item->report->profile_image)
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar avatar-sm me-3"><img
                                                                src="{{ asset($item->report->profile_image != '' ? $item->report->profile_image : 'user.png') }}"
                                                                alt="Avatar" class="rounded-circle">
                                                        </div>
                                                    </div>
                                                @else
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar avatar-sm me-3"><span
                                                                class="avatar-initial rounded-circle bg-label-danger">
                                                                {{ strtoupper(substr($item->report->first_name, 0, 2)) }}</span>
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="d-flex flex-column"><a href="#"
                                                        class="text-body text-truncate"><span
                                                            class="fw-semibold user-name-text">{{ $item->report->first_name }}
                                                            {{ $item->report->last_name }}
                                                        </span></a>
                                                    <small class="text-muted">&#64;{{ $item->report->email }}</small>
                                                </div>
                                            </div>
                                        ...
                                        <td class="" style="">
                                            <div class="d-flex align-items-center">
                                                <a href="{{ route('dashboard-report-user-detail',$item->id) }}" class="text-body delete-record"><i
                                                        class="ti ti-eye"></i></a>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="second">
                                                                    <a class="btn text-center"
                                                                        href="{{ url('dashboard/report/user/delete', $item->id) }}">Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
