...
@section('title', 'Mixxer Check In Feedback')
@section('main', 'Mixxer Check In Feedback Management')
@section('link')
                            ...
                            <tbody>
                                @foreach ($list as $item)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            {{ $item->issue_you_experiencing }}

                                        </td>
                                        
                                        <td>
                                            {{ $item->provide_more_details }}
                                        </td>
